...
<input type="file" id="imageUpload" accept="image/*" style="display: none" class="hidden" ; >
	</div>
    ...
    <div style="flex: 1; min-width: 200px;">
        <!-- <input type="text"
               ...
               placeholder="deliveryPerson ID"
               style="width: 100%; margin-bottom: 10px;"
               required
               value="< ?php echo htmlspecialchars($_GET['deliveryPerson_id'] ?? ''); ?>" /> -->
        <input type="text"
               name="fullname"
               placeholder="Name"
               style="width: 100%; margin-bottom: 10px;"
