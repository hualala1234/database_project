const prizes = [
  { message: '🎉 恭喜你獲得 20% 折扣優惠！', code: 'CLAWWIN20' },
  { message: '🎉 恭喜你獲得 30% 折扣優惠！', code: 'CLAWWIN30' },
  { message: '🎉 恭喜你獲得免運費1次！', code: 'CLAWSHIP' },
  { message: '🎉 恭喜你獲得 15% 折扣優惠！', code: 'CLAWWIN15' },
];
...
const { height: machineBottomHeight, top: machineBottomTop } = document
    ...
    setTimeout(() => {
      ...
      if (settings.targetToy) {
        ...
        setTimeout(() => {
          ...
          showPopupMessage(randomPrize);

          // showPopupMessage('🎉 恭喜你獲得 20% 折扣優惠！')
        }, 1000)  // 這邊可以再稍微等一下，看起來更自然
  ...
  function createPopup(prize) {
    ...
    title.textContent = prize.message
